...
public abstract class WeekView extends View implements View.OnClickListener {
    ...
    private void initPaint(Context context) {
        ...
        mCurMonthTextPaint.setColor(0xFFff0000);
    ...
    void setup(CustomCalendarViewDelegate delegate) {
        ...
        this.mSchemePaint.setColor(0xFFff0000);
        ...
        this.mSelectedPaint.setColor(0xffff0000); // 选中的圈圈的颜色
        ...
        for (int i = 0; i < 7; i++) {
            ...
            if (mDelegate.mSchemeDate != null && mDelegate.mSchemeDate.contains(calendar)) {
                ...
                if (isSelected) {
                    ...
                    //将画笔设置为标记颜色
                    //calendar.getSchemeColor() != 0 ? calendar.getSchemeColor() : mSchemeColor
                    mSchemePaint.setColor(0xffff0000);
