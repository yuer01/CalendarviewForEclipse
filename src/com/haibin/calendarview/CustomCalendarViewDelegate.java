...
class CustomCalendarViewDelegate {
    ...
    CustomCalendarViewDelegate(Context context,  AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CalendarView);
        mCurDayTextColor = array.getColor(R.styleable.CalendarView_current_day_text_color, Color.WHITE);// 当前天的颜色
